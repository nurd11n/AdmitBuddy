...
class UsersSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'first_name', 'last_name', 'is_case_complete', 'is_superuser', 'is_staff',  'is_active']
...
class ForgotPasswordSerializer(serializers.Serializer):
    ...
    def send_verification_email(self):
        ...
        send_password_celery.delay(user.email, user.create_activation_code)
